...
declare type DataProviderProxyMethod<TDataProviderMethod> = TDataProviderMethod extends (...a: any[]) => infer Result ? (...a: [
    ...Args: Parameters<TDataProviderMethod>,
    options?: UseDataProviderOptions
]) => Result : never;
export declare type DataProviderProxy<TDataProvider extends DataProvider = DataProvider> = {
...
export declare type Exporter = (data: any, fetchRelatedRecords: (data: any, field: string, resource: string) => Promise<any>, dataProvider: DataProviderProxy, resource?: string) => void | Promise<void>;
