...
db = conn.Database(
    DATABASE_HOST, DATABASE_USERNAME, DATABASE_PASSWORD, DATABASE_PORT, DATABASE_NAME
)
...
raw_user_2 = {
    "username": retrived_user[0],
    "password": str(retrived_user[1]),
    "salt": str(retrived_user[2]),
}
